...
//    @Query(
//            value = "select new project.noticeboard.dto.PostDto(p.id, p.title, p.content, m.username, p.createdAt, p.modifiedAt) " +
//                    "from Post p " +
//                    "inner join fetch p.member m",
//            countQuery = "select count(p) from Post p"
//    )
//    Page<PostDto> findAllPages(Pageable pageable);
